...
public class ScanVerifyResponse implements Serializable{
	...
	public static ScanVerifyResponse fromJson(JSONObject obj) {
		ScanVerifyResponse cc = null;
		try {
			cc = new ScanVerifyResponse();

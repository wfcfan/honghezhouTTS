...
public class ScanRemoveResponse implements Serializable{
	...
	public static ScanRemoveResponse fromJson(JSONObject obj) {
		ScanRemoveResponse sc = null;
		try {
			sc = new ScanRemoveResponse();

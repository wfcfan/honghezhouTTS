...
public class GetBizCorpCountResponse implements Serializable{
	...
	public static GetBizCorpCountResponse fromJson(JSONObject obj) {
		GetBizCorpCountResponse cc = null;
		try {
			cc = new GetBizCorpCountResponse();

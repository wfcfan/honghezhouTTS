...
public class GetWarehouseCountResponse implements Serializable{
	...
	public static GetWarehouseCountResponse fromJson(JSONObject obj) {
		GetWarehouseCountResponse cc = null;
		try {
			cc = new GetWarehouseCountResponse();

...
public class UploadChargeCodesResponse implements Serializable {
	...
	public static UploadChargeCodesResponse fromJson(JSONObject obj) {
		UploadChargeCodesResponse cp = null;
		try {
			cp = new UploadChargeCodesResponse();
